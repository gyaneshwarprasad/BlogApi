...
import com.blogapi.config.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
        ...
        // For assigning both the ROLE_ADMIN & ROLE_USER

        /* Role roleUser = roleRepository.findByName("ROLE_USER").orElseThrow(() -> new RuntimeException("ROLE_USER not found"));
